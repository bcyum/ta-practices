...
public class Lesson8Odev3 {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < metin.length; ++i) {
            ...
            if (!tekrarEdenKarakter.isEmpty()) {
                ...
                String tekrarEdenKelime = createRepeatingWord(metin[i], tekrarEdenKarakter);
    ...
    public static String createRepeatingWord(String cumle, Set<Character> characters) {
        StringBuilder kelime = new StringBuilder();
        char[] charArray = cumle.toLowerCase().toCharArray();

        for (char karakter : charArray) {
            if (characters.contains(karakter)) {
